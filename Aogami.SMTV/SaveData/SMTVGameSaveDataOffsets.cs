namespace Aogami.SMTV.SaveData
{
    public static class SMTVGameSaveDataOffsets
    {
        ...
        public const int DemonHpBase = 2708; // short
        public const int DemonHpBalm = 2740; // short
        public const int DemonHpTotal = 2776; // short
        public const int DemonMpBase = 2710; // short
        public const int DemonMpBalm = 2742; // short
        public const int DemonMpTotal = 2778; // short
